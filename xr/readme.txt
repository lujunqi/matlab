...
PAMI2012综述文章中，(pedestrian detection an evaluation of the state of the art 作者：Piotr Dollar),排名第2的算法：

加州理工学院2009年行人检测的文章：Integral Channel Features（积分通道特征）,作者：Piotr Dollar,代码http://www.vision.caltech.edu/Image_Datasets/CaltechPedestrians/
